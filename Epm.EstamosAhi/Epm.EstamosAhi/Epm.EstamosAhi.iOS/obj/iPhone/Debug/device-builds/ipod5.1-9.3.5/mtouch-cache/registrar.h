...
@class Epm_EstamosAhi_iOS_Renderizadores_ExtenderEntry;
@class Xamarin_Forms_Platform_iOS_LabelRenderer;
@class Epm_EstamosAhi_iOS_Renderizadores_ExtenderLabel;
@class Xamarin_Forms_Platform_iOS_ButtonRenderer;
@class Epm_EstamosAhi_iOS_Renderizadores_ExtenderButton;
...
@interface Epm_EstamosAhi_iOS_Renderizadores_ExtenderEntry : Xamarin_Forms_Platform_iOS_EntryRenderer {
}
	-(id) init;
@end
...
@interface Epm_EstamosAhi_iOS_Renderizadores_ExtenderLabel : Xamarin_Forms_Platform_iOS_LabelRenderer {
}
	-(id) init;
@end
...
@interface Epm_EstamosAhi_iOS_Renderizadores_ExtenderButton : Xamarin_Forms_Platform_iOS_ButtonRenderer {
}
	-(id) init;
@end
