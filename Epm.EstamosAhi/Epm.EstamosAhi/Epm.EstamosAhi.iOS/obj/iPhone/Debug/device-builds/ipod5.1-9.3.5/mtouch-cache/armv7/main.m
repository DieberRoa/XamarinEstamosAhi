...
extern void *mono_aot_module_Epm_EstamosAhi_iOS_info;
...
extern void *mono_aot_module_Epm_EstamosAhi_Infraestructura_info;
...
extern void *mono_aot_module_Epm_EstamosAhi_info;
extern void *mono_aot_module_Xamarin_Forms_Xaml_info;
extern void *mono_aot_module_Epm_EstamosAhi_Core_info;
extern void *mono_aot_module_GalaSoft_MvvmLight_info;
extern void *mono_aot_module_GalaSoft_MvvmLight_Extras_info;
extern void *mono_aot_module_ToastIOS_info;

void xamarin_register_modules_impl ()
{
	mono_aot_register_module (mono_aot_module_Epm_EstamosAhi_iOS_info);
	...
	mono_aot_register_module (mono_aot_module_Epm_EstamosAhi_Infraestructura_info);
	...
	mono_aot_register_module (mono_aot_module_Epm_EstamosAhi_info);
	mono_aot_register_module (mono_aot_module_Xamarin_Forms_Xaml_info);
	mono_aot_register_module (mono_aot_module_Epm_EstamosAhi_Core_info);
	...
	mono_aot_register_module (mono_aot_module_ToastIOS_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "Epm.EstamosAhi.iOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 2;
